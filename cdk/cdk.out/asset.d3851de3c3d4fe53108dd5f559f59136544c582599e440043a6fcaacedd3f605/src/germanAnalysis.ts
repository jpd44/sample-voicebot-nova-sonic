...
export async function analyzeGerman(
    ...
    const langName = ({ de: 'German', pt: 'Brazilian Portuguese', es: 'Latin American Spanish', it: 'Italian', fr: 'Metropolitan French', ru: 'Russian', tr: 'Turkish' } as Record<string, string>)[language.toLowerCase()] || 'German';
...
Analyze and return JSON.`;
    ...
    parsed.corrections = (parsed.corrections || []).filter(c => c && c.original && c.correct);
