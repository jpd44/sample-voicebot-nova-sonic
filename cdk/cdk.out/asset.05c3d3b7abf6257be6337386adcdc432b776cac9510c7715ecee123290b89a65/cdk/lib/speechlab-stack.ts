...
export class SpeechLabStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props: SpeechLabStackProps) {
        ...
        // ALB-fronted Fargate service. ALB listens on 443 with the cert; CloudFront sits in front
        // of the ALB and handles the public TLS edge. We deliberately do NOT pass domainName/domainZone
        // to this construct because the Route 53 A-record for the public hostname needs to point at
        // CloudFront, not the ALB — we create that record manually further down.
