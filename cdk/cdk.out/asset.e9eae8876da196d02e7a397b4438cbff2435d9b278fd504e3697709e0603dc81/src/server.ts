...
// Allowed origins for both Express (CORS) and Socket.IO. These are the daily-deutsch.com
// front-ends that may embed Speech Lab. Same-origin (speechlab.daily-deutsch.com) doesn't
// need a CORS allow since it's the host itself, but listing it is harmless.
const ALLOWED_ORIGINS = [
    'https://daily-deutsch.com',
    'https://www.daily-deutsch.com',
    'https://speechlab.daily-deutsch.com',
    // Local dev origins for daily-deutsch (Vite default + custom)
    'http://localhost:5173',
    'http://127.0.0.1:5173',
];
...
// CORS for the REST + auth-config endpoints. Mirrors the Socket.IO origin allow list.
